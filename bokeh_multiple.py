...
fig2.circle(setosa_petal_length, setosa_petal_width, color = palette[0], legend_label= 'setosa')
fig2.circle(versicolor_petal_length, versicolor_petal_width, color = palette[1], legend_label= 'versicolor')
fig2.circle(virginica_petal_length, virginica_petal_width, color = palette[2], legend_label= 'virginica')
